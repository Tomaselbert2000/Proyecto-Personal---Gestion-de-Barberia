...
import static com.launcher.constants.entity_constraints.subject.SettingsUpdateMessageSubject.*;
...
public class SettingsUpdateDTO {
    ...
    @Size(max = MAX_OPTIONAL_DESCRIPTION_LENGTH, message = BARBER_SHOP_ADDRESS + OPTIONAL_TEXT_OR_DESCRIPTION_MAX_SIZE)
