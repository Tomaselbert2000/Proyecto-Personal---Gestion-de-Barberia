...
public class ClientCreationController extends BaseCrudFormController<ClientCreationDTO, ClientInfoDTO> {
    ...
    @Override
    protected void persistEntity(ClientCreationDTO dto) {
    ...
    protected String getSuccessMessage() {
        return CLIENT_CREATION_TOAST_NOTIFICATION_MESSAGE;
    }

    @Override
    protected String getErrorMessage() {
        return CLIENT_CREATION_VALIDATION_FAILED;
    }

    @Override
    protected ClientCreationDTO buildDTO() {
