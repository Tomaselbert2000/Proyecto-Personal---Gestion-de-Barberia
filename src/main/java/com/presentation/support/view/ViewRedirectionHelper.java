...
import com.presentation.navigation.SceneManager;
    ...
    public void redirectToView(ViewRedirection destination, Pane borderPane, ApplicationContext applicationContext) {
        switch (destination) {
            ...
            case PAYMENT_METHOD_CREATION ->
                    loadViewOnPane(PAYMENT_METHOD_CREATION_VIEW_PATH, applicationContext, PAYMENT_METHOD_CREATION_VIEW_LOADING_FAILED, borderPane);
            case PAYMENT_METHOD_EDITION ->
                    loadViewOnPane(PAYMENT_METHOD_EDITION_VIEW_PATH, applicationContext, PAYMENT_METHOD_EDITION_VIEW_LOADING_FAILED, borderPane);
            case SALES -> loadViewOnPane(SALE_VIEW_PATH, applicationContext, SALE_VIEW_PATH_LOADING_FAILED, borderPane);
            case SALE_DETAIL ->
                    loadViewOnPane(SALE_DETAIL_VIEW_PATH, applicationContext, SALE_DETAIL_VIEW_LOADING_FAILED, borderPane);
            case SALE_CREATION ->
                    loadViewOnPane(SALE_CREATION_VIEW_PATH, applicationContext, SALE_CREATION_VIEW_LOADING_FAILED, borderPane);
            case SETTINGS ->
