package com.launcher.constants.ui.messages;
...
public final class ViewLoadingErrorMessage {
    ...
    public static final String DELETE_CONFIRMATION_DIALOG_VIEW_LOADING_FAILED = "Hubo un error al cargar el diálogo de confirmación.";
}
