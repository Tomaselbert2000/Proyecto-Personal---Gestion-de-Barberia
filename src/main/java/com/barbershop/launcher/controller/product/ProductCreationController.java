...
public class ProductCreationController {
    ...
    public void initialize() {
        ...
        configurePromptTextsOnTextfields();
    ...
    private void configurePromptTextsOnTextfields() {
        ...
        List<TextField> textfields = List.of(name, brand_name, product_presentation_field, optional_description);
        List<String> promptTexts = List.of(PRODUCT_NAME, PRODUCT_BRAND, PRODUCT_SIZE_OR_VOLUME, PRODUCT_OPTIONAL_DESCRIPTION);

        Map<TextField, String> map = generateMap(textfields, promptTexts);
